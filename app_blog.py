...
app.layout = html.Div(
    children=[
        html.H1("Leaves Disease Detection", style={"font-family": "Arial, sans-serif", "color": "#333", "margin-bottom": "10px"}),
        html.H2("Design Credit Implementation", style={"font-family": "Arial, sans-serif", "color": "#666"}),
        html.H3("Gaurav Sangwan B20AI062, Dr. Arpit Khandelwal, Mr. Sanchit Aggarwal, Miss. Mamatha Raghu", style={"font-family": "Arial, sans-serif", "color": "#999"}),
